...
void Sk6812RgbwPi::begin(uint8_t *led_array, uint32_t num_leds, uint8_t brightness, int spi_channel){
    // Adding pointer references and other important LED information. 
    this->led_array = led_array; 
    this->num_leds = num_leds; 
    this->brightness = brightness;
    this->led_array_size = this->num_leds * 16 + 200; 
...
void Sk6812RgbwPi::set(uint8_t r, uint8_t g, uint8_t b, uint8_t w, uint32_t led){
    // sets up brightness!
